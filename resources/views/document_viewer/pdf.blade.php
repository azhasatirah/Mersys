...
<head>
    ...
    <link rel="stylesheet" href="{{asset('document_viewer/pdf/web/viewer.css')}}">


    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="{{asset('document_viewer/pdf/web/locale/locale.properties')}}">
    <script src="{{asset('document_viewer/pdf/build/pdf.js')}}"></script>

</head>

<body tabindex="1">
    <input type="hidden" value="{{$modul}}" id="modul">
    ...
    <script src="{{asset('document_viewer/pdf/web/viewer.js')}}"></script>
</body>
