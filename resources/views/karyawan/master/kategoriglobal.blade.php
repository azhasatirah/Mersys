...
<div class="row">
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Kategori Global <small></small></h2>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Kategori Global:</label>
            <input type="text" name="kategoriglobal"class="form-control" >
          </div>
          <div class="form-group">
        ...
        @csrf
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" id="editnama" name="kategoriglobal"class="form-control" >
...
@push('scripts')
    <script src="{{asset('assets/js/master/kategoriglobal.js')}}"></script>
