...
<div class="row">
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Kategori Materi <small></small></h2>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" name="kategorimateri"class="form-control" >
          </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Kategori Program:</label>
              <input type="text" id="editnama" name="kategorimateri"class="form-control" >
...
@push('scripts')
    <script src="{{asset('assets/js/master/kategorimateri.js')}}"></script>
